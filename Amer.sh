...
chmod +x *
cd
cp $HOME/Virus4/Virus4.py $HOME/../usr/bin/Virus4.py
cp $HOME/Virus4/Virus4.py $HOME/../usr/bin/Virus
cd
rm -rf Virus
rm -rf Virus4.zip
...
cp $HOME/Virus4/Virus4.py $HOME/../usr/bin/Virus4.py
cp $HOME/Virus4/Virus4.py $HOME/../usr/bin/Virus
cp $HOME/Virus4/Virus4.py $HOME/../usr/bin/Virus4
cp $HOME/Virus4/Virus4.py $HOME/../usr/bin/virus
